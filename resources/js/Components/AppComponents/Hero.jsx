    ...
    return (
        <section className="relative w-full h-screen overflow-hidden">
            ...
            <div className="absolute inset-0">
                <video
                    src="/Hero.mp4" // <-- public folder path
                    autoPlay
                    loop
                    muted
                    playsInline
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center text-white">
                ...
                >
                    <Link
                        href={`/shop`}
                        className="
                            px-10 py-4 border border-[#C6A15B] text-white text-xs tracking-[0.25em] uppercase font-body font-light
                            hover:bg-[#C6A15B] hover:text-black transition-all duration-500
                        "
                    >
                        Shop Now
                    </Link>

      ...
      <section className="min-h-[90vh] py-12 bg-white mt-[4rem]">
        <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          {cartItems.length === 0 ? (
            ...
            <>
              {/* Cart Table Header */}
              <div className="hidden mb-4 border-b md:grid md:grid-cols-4 md:gap-4">
              ...
              <div className="flex flex-col items-end mt-12 space-y-4 md:flex-row md:justify-between md:items-center">
                <div className="text-right md:text-left">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    By shopping, you agree to our Terms of Service, Privacy
                    Policy, and Refund Policy.
                  </p>
                </div>

                <Link href="/checkout" className="w-full mt-4 md:w-auto md:mt-0">
                  <button className="w-full px-6 py-3 text-sm font-medium text-white transition-colors bg-black hover:bg-gray-900">
                    Check out
                  </button>
                </Link>
              </div>
...
//                                     </p>
//                                     <p className="mt-1 text-sm text-gray-600">
//                                         Tax included. Shipping and discounts
//                                         calculated at checkout.
//                                     </p>
//                                     <p className="mt-2 text-xs text-gray-500">
//                                         By shopping, you agree to our Terms of
//                                         Service, Privacy Policy, and Refund
//                                         Policy.
//                                     </p>
//                                 </div>
